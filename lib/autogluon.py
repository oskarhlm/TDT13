...
class MultilabelPredictor():
    """ Taken from https://github.com/autogluon/autogluon/blob/287f0025c68df876759e4eb663758a23c231e262/docs/tutorials/tabular/advanced/tabular-multilabel.ipynb#L18
    ...
    def __init__(self, labels, path=None, problem_types=None, eval_metrics=None, consider_labels_correlation=True, **kwargs):
        ...
        if eval_metrics is None:
            ...
            self.eval_metrics = {labels[i]: eval_metrics[i]
    ...
    def fit(self, train_data, tuning_data=None, **kwargs):
        ...
        for i in range(len(self.labels)):
            ...
            predictor.fit(train_data=train_data,
                          tuning_data=tuning_data, **kwargs)
